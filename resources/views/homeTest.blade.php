...
<!--                 <div class="brand text-center">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img class="d-block w-100" src="{{ asset('material-kit-html-v2.0.4/assets/img/bg2.jpg') }}" alt="First slide">
                  ...
                  <div class="carousel-item">
                    <img class="d-block w-100" src="{{ asset('material-kit-html-v2.0.4/assets/img/bg3.jpg') }}" alt="Second slide">
                    <div class="carousel-caption d-none d-md-block">
                      <h4>
                  ...
                  <div class="carousel-item">
                    <img class="d-block w-100" src="{{ asset('material-kit-html-v2.0.4/assets/img/bg.jpg') }}" alt="Third slide">
                    <div class="carousel-caption d-none d-md-block">
                      <h4>
                        <i class="material-icons">location_on</i> Yellowstone National Park, United States
                      </h4>
